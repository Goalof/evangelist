...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section background="linear-gradient(180deg, #0E1317 0%, #22262E 100%)" padding="130px 0 130px 0">
			<Text text-align="center" font="normal 400 90px/114px --fontFamily-sans" color="#ffffff" margin="16px 0px 100px 0px">
			...
			<Stack>
				...
				>
					...
					<Box width="100%" display="flex">
						...
						<Text margin="16px 0px 16px 36px">
							Some text
						</Text>
					</Box>
		...
		<Section padding="120px 0 120px 0" background="rgba(0, 0, 0, 0) linear-gradient(0deg, rgb(14, 19, 23) 0%, rgb(34, 38, 46) 100%) repeat scroll 0% 0% / auto padding-box border-box">
		...
		<Section padding="30px 0 30px 0" background="--color-darkL1">
			<Stack>
				{"    "}{"    "}
				<StackItem width="100%" display="flex" flex-direction="column" padding="16px 0px 16px 16px">
					<Override
						slot="StackItemContent"
						flex-direction="column"
						background="#22262E"
